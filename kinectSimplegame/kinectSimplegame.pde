...
PImage img;
void setup() {
  tile1 = loadImage("/data/tile-1.jpg");
  starSetup();
  noStroke();
  kinectSetup();
  size(1280,960,P3D);
...
void draw () {
  ...
  float xx = 60-kinectX/4.25; //left-right
  float yy = ypos+60+((512.0-kinectY)/5.0); // front-back
